...
API_PORT=4000
API_HOST=0.0.0.0
API_BASE_URL=https://api.tripbng.in  # Change to your backend sub-domain
...
CORS_ORIGINS=https://partnerhub.tripbng.in      # Change to your frontend domain
...
```env
NEXT_PUBLIC_API_BASE_URL=https://api.tripbng.in   # Points to your backend domain
...
2.  **Create an Nginx configuration file**:
    ...
    Paste the following server block, substituting `partnerhub.tripbng.in` and `api.tripbng.in` with your actual domain names:
    ```nginx
    # ----------------------------------------------------
    # 1. FRONTEND SERVER (partnerhub.tripbng.in)
    # ----------------------------------------------------
    server {
        listen 80;
        server_name partnerhub.tripbng.in www.partnerhub.tripbng.in;
    ...
    # ----------------------------------------------------
    # 2. BACKEND API SERVER (api.tripbng.in)
    # ----------------------------------------------------
    server {
        listen 80;
        server_name api.tripbng.in;
...
2.  **Generate Certificates & Configure Nginx automatically**:
    ```bash
    sudo certbot --nginx -d partnerhub.tripbng.in -d www.partnerhub.tripbng.in -d api.tripbng.in
    ```
...
*   **Frontend**: `https://partnerhub.tripbng.in`
*   **Backend API**: `https://api.tripbng.in`
